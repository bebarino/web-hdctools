...
var libflashrom = (function() {
  var _scriptDir = import.meta.url;
  
  return (
function(libflashrom) {
  libflashrom = libflashrom || {};
...
var Module = typeof libflashrom !== 'undefined' ? libflashrom : {};
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 276512,
    DYNAMIC_BASE = 5519392,
    DYNAMICTOP_PTR = 276352;
...
var wasmBinaryFile = 'libflashrom.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var USB={device:null,interfaceNumber:-1};function _init_raiden_device(serial, interfaceNumber, in_endpoint, out_endpoint) {
  ...
  function _libusb_bulk_transfer(handle, endpoint, data, length, transferred, timeout) {
  		return Asyncify.handleSleep(async function(wakeUp) {
  			if (endpoint & 0x80) {
  ...
  function _libusb_control_transfer(handle, bmRequestType, bRequest, wValue, wIndex, data, wLength, timeout) {
  		return Asyncify.handleSleep(async function(wakeUp) {
...
var asmGlobalArg = {};
var asmLibraryArg = { "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "exit": _exit, "fd_close": _fd_close, "fd_seek": _fd_seek, "fd_write": _fd_write, "init_raiden_device": _init_raiden_device, "libusb_bulk_transfer": _libusb_bulk_transfer, "libusb_control_transfer": _libusb_control_transfer, "libusb_init": _libusb_init, "memory": wasmMemory, "nanosleep": _nanosleep, "setTempRet0": _setTempRet0, "table": wasmTable, "usleep": _usleep };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _flashrom_image_read = Module["_flashrom_image_read"] = function() {
  return (_flashrom_image_read = Module["_flashrom_image_read"] = Module["asm"]["flashrom_image_read"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_image_write = Module["_flashrom_image_write"] = function() {
  return (_flashrom_image_write = Module["_flashrom_image_write"] = Module["asm"]["flashrom_image_write"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_version_info = Module["_flashrom_version_info"] = function() {
  return (_flashrom_version_info = Module["_flashrom_version_info"] = Module["asm"]["flashrom_version_info"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_supported_programmers = Module["_flashrom_supported_programmers"] = function() {
  return (_flashrom_supported_programmers = Module["_flashrom_supported_programmers"] = Module["asm"]["flashrom_supported_programmers"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_data_free = Module["_flashrom_data_free"] = function() {
  return (_flashrom_data_free = Module["_flashrom_data_free"] = Module["asm"]["flashrom_data_free"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_programmer_shutdown = Module["_flashrom_programmer_shutdown"] = function() {
  return (_flashrom_programmer_shutdown = Module["_flashrom_programmer_shutdown"] = Module["asm"]["flashrom_programmer_shutdown"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_flash_getsize = Module["_flashrom_flash_getsize"] = function() {
  return (_flashrom_flash_getsize = Module["_flashrom_flash_getsize"] = Module["asm"]["flashrom_flash_getsize"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_flash_getname = Module["_flashrom_flash_getname"] = function() {
  return (_flashrom_flash_getname = Module["_flashrom_flash_getname"] = Module["asm"]["flashrom_flash_getname"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_flash_getvendor = Module["_flashrom_flash_getvendor"] = function() {
  return (_flashrom_flash_getvendor = Module["_flashrom_flash_getvendor"] = Module["asm"]["flashrom_flash_getvendor"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _flashrom_flash_release = Module["_flashrom_flash_release"] = function() {
  return (_flashrom_flash_release = Module["_flashrom_flash_release"] = Module["asm"]["flashrom_flash_release"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _wasm_flashrom_lib_init = Module["_wasm_flashrom_lib_init"] = function() {
  return (_wasm_flashrom_lib_init = Module["_wasm_flashrom_lib_init"] = Module["asm"]["wasm_flashrom_lib_init"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _wasm_setup_programmer = Module["_wasm_setup_programmer"] = function() {
  return (_wasm_setup_programmer = Module["_wasm_setup_programmer"] = Module["asm"]["wasm_setup_programmer"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _wasm_probe_flash = Module["_wasm_probe_flash"] = function() {
  return (_wasm_probe_flash = Module["_wasm_probe_flash"] = Module["asm"]["wasm_probe_flash"]).apply(null, arguments);
};
